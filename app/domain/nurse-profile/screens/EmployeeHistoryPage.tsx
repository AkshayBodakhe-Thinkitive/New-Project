...
const EmployeeHistoryPage = () => {
  return (
    <View style={styles.container}>
      <View style={styles.cardContainer}>
        <Card style={styles.cardStyles}>
          <Row style={styles.row1Style}>
            <CustomText style={styles.eduInfo}>Employment Info</CustomText>
          ...
          <Row style={styles.row2Style}>
            <View style={styles.detailsView}>
              <CustomText color={colors.grey70}>Job Title</CustomText>
              <CustomText>Caregiver</CustomText>
            </View>
            <View style={styles.detailsView}>
              <CustomText color={colors.grey70}>Company Name</CustomText>
              <CustomText>BPharma</CustomText>
            </View>
            <View style={styles.detailsView}>
              <CustomText color={colors.grey70}>Job Type</CustomText>
        ...
        <Card style={styles.card2Styles}>
          ...
          <Row style={styles.docPreviewRow}>
            <Row style={styles.docPreview}>
              ...
              <CustomText>Experience Letter</CustomText>
      ...
      <Row style={styles.addEmpRow}>
        <CustomText fontFamily={FontType.figtree_semibold}>Add New Employment</CustomText>
        <AntIcon name='plus'/>
      </Row>
    </View>
  );
